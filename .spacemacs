...
Put your configuration code here, except for variables that should be set before packages are loaded."
  ...
  (setenv "PATH" (concat (getenv "PATH") ":/home/sam/.cargo/bin"))

  ;; CHECK FOR JSON SERIALIZE (functionp 'json-serialize)
